...
util.inherits(ArduinoNode, EventEmitter);
function ArduinoNode(host, port, offValue)
{
    EventEmitter.call(this);
    var initialized;
    var log = logging.getLogger('ArduinoNode');
    var sendCount = 0;
    var events = this;
    //var sock = dgram.createSocket({ type: 'udp4', reuseAddr: false });
...
function ArduinoNodeLight(id, opts) {
    var log = logging.getLogger('ArduinoNodeLight');
    var me = this;
    _.extend(this, _.bindAll({
        id: id,
        value: 0,
